...
class L10nKo extends L10n {
  ...
  @override
  String get kickAfkAction => '강퇴';

  @override
  String kickAfkConfirmTitleOffline(String nickname) {
    return '연결이 끊긴 $nickname님을 강퇴할까요?';
  }

  @override
  String kickAfkConfirmTitleIdle(String nickname) {
    return '응답이 없는 $nickname님을 강퇴할까요?';
  }

  @override
  String get kickAfkConfirmBody =>
      '빈자리는 봇이 이어받고 게임은 그대로 진행됩니다. 강퇴된 분에게는 중도탈주가 기록됩니다.';

  @override
  String get kickAfkConfirmAction => '강퇴하기';
  ...
  @override
  String get lobbyTichuRandomSeating => '티츄 - 랜덤팀';

  @override
  String get lobbyRandomSeatingOn => '랜덤팀';

  @override
  String get lobbyRandomSeatingOff => '고정팀';
  ...
  String get rulesMtGoalBody =>
      '5명 또는 6명이 즐기는 트릭테이킹 카드 게임입니다. 한 명이 주공이 되어 프렌드를 지정하고, 둘이서 비딩한 점수 이상의 점수 카드를 모아야 합니다. 나머지 플레이어는 수비팀(야당)이 되어 이를 저지합니다.\n\n※ 6인이 모이면 자동으로 킬 마이티 규칙이 적용되며, 방장이 한 자리를 잠그면 5인 마이티로 플레이합니다.';
  ...
  String get rulesMtBiddingBody =>
      '플레이어들은 차례대로 비딩하며, 20점 중 몇 점을 획득할지 선언합니다.\n\n• 최소 비딩: 5인 모드 13, 6인 킬 마이티 14\n• 최대 비딩: 20\n\n가장 높은 비딩을 한 플레이어가 주공이 되어 기루다(으뜸 문양)를 선택합니다. 모든 플레이어가 패스하면 무승부로 카드를 다시 나눕니다.\n\n※ 비딩 중 손패가 약하면 딜미스를 선언해 새 라운드를 시작할 수 있습니다.';

  @override
  String get rulesMtDealMissTitle => '딜미스 (Deal Miss)';

  @override
  String get rulesMtDealMissBody =>
      '비딩 단계에서 손패가 매우 약하면 딜미스를 선언할 수 있습니다.\n\n[손패 점수 계산]\n• 스페이드 A = 0점\n• 조커 = 손패 점수 카드 중 가장 값이 큰 1장을 상쇄\n• A / K / Q / J = 각 1점\n• 10 = 0.5점\n\n[선언 조건]\n• 내 차례이며 아직 비딩이나 패스를 하지 않은 상태\n• 5인 마이티: 손패 점수 0.5점 이하\n• 6인 킬 마이티: 손패 점수 정확히 0점\n\n[효과]\n• 선언자 즉시 −5점\n• 이 5점은 \"딜미스 풀\"에 누적\n• 카드를 다시 섞어 같은 딜러가 재분배, 새 비딩 시작\n• 풀은 다음으로 성공하는 주공이 보너스로 획득 (실패 시 유지)';

  @override
  String get rulesMtKillTitle => '킬 선언 (6인 전용)';

  @override
  String get rulesMtKillBody =>
      '6명이 모이면 비딩 종료 후 주공이 \"죽일 카드\" 한 장을 지정하는 킬 단계가 추가됩니다. 자기 손패에 있는 카드는 킬할 수 없습니다.\n\n[① 킬 성공 — 지정 카드가 다른 플레이어 손에 있을 때]\n• 피킬자의 손패 8장 + 바닥 키티 5장 = 13장을 다시 섞음\n• 주공이 5장, 나머지 4명이 각 2장 수령\n• 피킬자는 이 라운드에서 제외 (점수 0점)\n• 이후 5인 마이티와 동일하게 진행 (3장 버리고 친구 지정)\n\n[② 주공 자살 — 지정 카드가 바닥 키티에 있을 때]\n• 주공의 손패 8장 + 바닥 5장 = 13장 재분배\n• 나머지 5명이 각 2장, 남은 3장은 새 키티\n• 주공은 라운드 제외 (0점)\n• 5인 마이티 비딩을 처음부터 다시 시작 (최소 13, 딜미스 0.5점)';
  ...
  String get rulesMtScoringBody =>
      '덱에 점수 카드 20장 (A, K, Q, J, 10 × 4문양 = 20장).\n\n[성공 점수]\n기본 = (비딩 − 최소비딩 + 1) × 2 + (먹은 점수 − 비딩)\n\n점수 배분:\n• 주공: 기본 × 2  (솔로는 × 4 — 프렌드 없으니 야당이 한 명 더)\n• 프렌드: 기본 × 1\n• 야당 각: −기본\n\n배율 (기본 점수에 곱셈, 주공·프렌드·야당 모두에 적용):\n• 런 (20점 올킬): ×2\n• 노기루다 (NT): ×2\n• 20비딩: ×2\n최대 배율: ×8 (런 + NT + 20비딩)\n\n[실패 점수]\n단위 = (비딩 − 먹은 점수)\n\n점수 배분:\n• 주공: −단위 × 2\n• 프렌드: −단위\n• 야당 각: +단위\n\n실패 배율:\n• 솔로 (노프렌드): 주공 −단위 × 2 × 2 = ×4 (프렌드 없으니 야당이 한 명 더)\n• 백런 (여당 10점 이하 = 야당 10점 이상): 모든 측 ×2 (비딩과 무관하게 적용)\n\n[성공 예시]\n13비딩, 프렌드 있음, 15점 획득:\n기본 = (1×2) + 2 = 4\n주공 +8, 프렌드 +4, 야당 각 −4\n\n[노프렌드 성공 예시]\n14비딩, 노프렌드, 16점 획득:\n기본 = (2×2) + 2 = 6\n주공 +24 (기본 × 4), 야당 각 −6\n(NT였다면 기본 12 → 주공 +48, 야당 각 −12)\n\n[실패 예시]\n17비딩, 프렌드 있음, 15점 획득 (2점 미달):\n단위 = 2  (백런 X)\n주공 −4, 프렌드 −2, 야당 각 +2\n\n[실패 + 백런 예시]\n17비딩, 프렌드 있음, 10점 획득 (백런):\n단위 = 7 × 2(백런) = 14\n주공 −28, 프렌드 −14, 야당 각 +14\n\n[실패 + 솔로 + 백런 예시]\n17비딩, 솔로, 5점 획득 (12점 미달, 백런):\n단위 = 12 × 2(백런) = 24\n주공 −24 × 4 = −96, 야당 각 +24';
  ...
  @override
  String get profilePhotoCameraDeniedTitle => '카메라 권한이 필요합니다';

  @override
  String get profilePhotoCameraDeniedBody => '사진을 촬영하려면 설정에서 카메라 접근을 허용해 주세요.';

  @override
  String get profilePhotoOpenSettings => '설정으로 이동';

  @override
  String get profilePhotoPhotoDeniedTitle => '사진 접근 권한이 필요합니다';

  @override
  String get profilePhotoPhotoDeniedBody => '사진을 선택하려면 설정에서 사진 접근을 허용해 주세요.';
  ...
  @override
  String get appForceUpdateBodyWeb => '새 버전이 배포되었습니다.\n새로고침하면 바로 이용할 수 있습니다.';
