...
class L10nEn extends L10n {
  ...
  @override
  String get profileMatchHistoryTitle => 'Match History';
  ...
  @override
  String get profileOutcomeDesertion => 'Desertion';

  @override
  String get profileOutcomeMidLeave => 'Walked out';
  ...
  @override
  String get lobbyBotStrategyMixexpectimax => 'Mix Oracle (rules + oracle)';
  ...
  String get rulesMtScoringBody =>
      '20 point cards in the deck (A, K, Q, J, 10 × 4 suits = 20).\n\n[Success Score]\nBase = (Bid − minBid + 1) × 2 + (points collected − bid)\n\nDistribution:\n• Declarer: Base × 2  (solo: × 4 — no partner, one extra defender)\n• Friend: Base × 1\n• Each Defender: −Base\n\nMultipliers (stack, applied to every side):\n• Run (all 20 pts): ×2\n• No Trump: ×2\n• Bid 20: ×2\nMax: ×8 (run + NT + bid 20)\n\n[Failure Score]\nUnit = (bid − points collected)\n\nDistribution:\n• Declarer: −Unit × 2\n• Friend: −Unit\n• Each Defender: +Unit\n\nFailure multipliers:\n• Solo (no friend): declarer −Unit × 2 × 2 = ×4 (no partner, one extra defender)\n• Backrun (declarer team ≤ 10 pts collected = defenders ≥ 10 pts): ×2 to all sides, regardless of bid level\n\n[Success example]\nBid 13, 15 pts with a friend:\nBase = (1×2) + 2 = 4\nDeclarer +8, Friend +4, Defenders −4 each\n\n[Solo success example]\nBid 14, no friend, 16 pts:\nBase = (2×2) + 2 = 6\nDeclarer +24 (Base × 4), Defenders −6 each\n(with NT: Base 12 → Declarer +48, Defenders −12 each)\n\n[Failure example]\nBid 17, 15 pts with a friend (short by 2):\nUnit = 2  (no backrun)\nDeclarer −4, Friend −2, Defenders +2 each\n\n[Failure + backrun]\nBid 17, 10 pts (backrun):\nUnit = 7 × 2 = 14\nDeclarer −28, Friend −14, Defenders +14 each\n\n[Failure + solo + backrun]\nBid 17, solo, 5 pts (short by 12, backrun):\nUnit = 12 × 2 = 24\nDeclarer −24 × 4 = −96, Defenders +24 each';
  ...
  @override
  String get mtBidInProgress => 'Bidding in progress';
  ...
  String mtRaiseBidConfirmBody(Object points) {
    return 'Raise the bid to $points?';
  }

  @override
  String get mtChangeTrumpConfirmTitle => 'Change trump';

  @override
  String mtChangeTrumpConfirmBody(Object points, Object suit) {
    return 'Change trump to $suit and raise the bid to $points?';
  }

  @override
  String mtChangeTrumpNoPenaltyBody(Object suit) {
    return 'Change trump to $suit?';
  }
  ...
  @override
  String get mtJokerSelectSuit => 'Select a joker suit';
  ...
  String shopGoldCurrent(int gold) {
    ...
    return 'Current gold: $goldString';
  }
  ...
  @override
  String get shopUseConfirmTitle => 'Use Item';
  ...
  @override
  String get shopStatusReadyToUse => 'Ready to Use';
  ...
  @override
  String get shopTagConsumable => 'Consumable';
  ...
  @override
  String get shopDetailConsumable => 'Consumable';
  ...
  @override
  String get profileAllGames => 'All Games';
  ...
  @override
  String get lobbyShareSheetTitle => 'Share room';

  @override
  String get lobbyShareCopyLink => 'Copy link';

  @override
  String get lobbyShareKakao => 'Share on KakaoTalk';
  ...
  String get lobbyNoRoomsForFilter =>
      'No rooms in this game\nTap All to see the others';

  @override
  String get lobbyAllowSpectators => 'Allow spectators';
